      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {notification.content && (
            <div className="mt-3 p-3 bg-neutral-800 dark:bg-white rounded-lg border border-gray-200 dark:border-yellow-700 text-gray-700 dark:text-gray-900 text-sm sm:text-base">
              {notification.content}
            </div>
          )}
          ...
          {notification.type === 'invite' && (
            <div className="flex gap-3 mt-3" onClick={(e) => e.stopPropagation()}>
              <button
                ...
                className="px-6 py-2 rounded-lg border border-yellow-700 text-gray-700 dark:text-gray-900 font-medium hover:bg-gray-50 dark:hover:bg-neutral-800 transition-colors"
              >
                Ignore
              </button>
              <button
